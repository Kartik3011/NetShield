...
st.markdown(
    """
    <div class="bottom-note-box" style="background-color: #262626; padding: 15px; margin-top: 20px;
    border-radius: 5px;
     border-left: 5px solid #28a745;">
      <ul style="font-size: 16px; margin: 0; color: #fff; padding-left: 20px; list-style-type: disc;">
       <strong>Note on Re-Searching:</strong> 
        <li>
            If you are searching for a new tag or video for a second time, please <strong> clear the cache of the website (top right 3 buttons), refresh your browser page (press F5 or Cmd+R) and come back to this page.</strong>
        </li>
        <li>
